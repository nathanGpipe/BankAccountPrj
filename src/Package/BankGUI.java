...
public class BankGUI extends JFrame implements ItemListener {
	...
	private void createAndShowGUI() {
		...
		// test values
		model.add(new SavingsAccount(321,"date","",1.1,1.1,1.1));
		model.add(new SavingsAccount(123,"date","1345",1.1,1.1,1.1));
		model.add(new SavingsAccount(111,"date","",1.1,1.1,1.1));
